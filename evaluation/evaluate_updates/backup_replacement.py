    ...
    for cluster_id in clusters:
        ...
        for suspicious_id in suspicious_clients.get(cluster_id, []):
            ...
            if valid_backups:
                ...
                available_backups = [
                    client_id for client_id in backups if client_id in evaluated_backups
                ]

                candidates = [suspicious_id] + available_backups
                ...
                accepted_clients[cluster_id].append(
                    (best_candidate, SUSPICIOUS_PENALTY)
                )
